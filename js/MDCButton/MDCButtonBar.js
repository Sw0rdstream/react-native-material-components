...
export default class MDCButtonBar extends React.Component {
...
static defaultProps = {
  ...
  render() {
    return <NativeMDCButtonBar {...this.props} />;
  }
}

const NativeMDCButtonBar = requireNativeComponent('RCTMDCButtonBar', MDCButtonBar);
